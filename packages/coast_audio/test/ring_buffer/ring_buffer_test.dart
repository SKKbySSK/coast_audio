...
void main() {
  ...
  test('output == input overflow', () {
    ...
    for (var i = 0; 10 > i; i++) {
      final offset = i * 10;
      ringBuffer.write(pInput.cast(), offset, 3); // length: 3, read: 0
      ringBuffer.write(pInput.cast(), offset + 3, 6); // length: 9, read: 0
      ringBuffer.write(pInput.cast(), offset + 9, 5); // length: 10, read: 0
      ringBuffer.read(pOutput.cast(), offset, 10); // length: 0, read: 10
    }
