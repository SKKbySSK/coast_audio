...
class MaBridge {
  ...
  late final _timezone =
      _timezonePtr.asFunction<ffi.Pointer<ffi.Char> Function(int, int)>();
...
class arm_exception_state extends ffi.Struct {
  @__uint32_t()
...
class arm_exception_state64 extends ffi.Struct {
  @__uint64_t()
  external int far;
...
class arm_thread_state extends ffi.Struct {
  @ffi.Array.multi([13])
...
class arm_thread_state64 extends ffi.Struct {
  @ffi.Array.multi([29])
...
class arm_vfp_state extends ffi.Struct {
  @ffi.Array.multi([64])
  external ffi.Array<__uint32_t> r;
...
class arm_neon_state64 extends ffi.Opaque {}

class arm_neon_state extends ffi.Opaque {}
...
class arm_legacy_debug_state extends ffi.Struct {
  @ffi.Array.multi([16])
...
class arm_debug_state32 extends ffi.Struct {
  @ffi.Array.multi([16])
  external ffi.Array<__uint32_t> bvr;
...
class arm_debug_state64 extends ffi.Struct {
  @ffi.Array.multi([16])
...
class arm_cpmu_state64 extends ffi.Struct {
  @ffi.Array.multi([16])
  external ffi.Array<__uint64_t> ctrs;
}

class mcontext32 extends ffi.Struct {
...
class mcontext64 extends ffi.Opaque {}

class sigaltstack extends ffi.Struct {
...
class ucontext extends ffi.Struct {
  @ffi.Int()
...
class user32_timeval extends ffi.Struct {
  @user32_time_t()
  external int tv_sec;
...
class user64_timeval extends ffi.Struct {
  @user64_time_t()
  external int tv_sec;
...
class rusage_superset extends ffi.Struct {
  external rusage ru;
...
class rusage_info_child extends ffi.Struct {
  @ffi.Uint64()
  external int ri_child_user_time;
...
class user64_rusage extends ffi.Struct {
...
class user32_rusage extends ffi.Struct {
